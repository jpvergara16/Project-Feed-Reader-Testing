...
$(function() {
    ...
    describe('RSS Feeds', function() {
        ...
        it('URL defined & not empty', function() {
            for (var i = 0; i < allFeeds.length; i++) {
                ...
                expect(allFeeds[i].url.length).not.toBe(0); // Check if URL is not empty
            }
        });
        ...
        it('name defined & not empty', function() {
            for (var i = 0; i < allFeeds.length; i++) {
                ...
                expect(allFeeds[i].url.length).not.toBe(0); // Check if name is not empty
            }
        });
    });
    ...
    describe("The Menu", function() {
        ...
        it('Menu element hidden by default', function() {
            expect($('body').hasClass("menu-hidden")).toBe(true); //Checks if menu element hidden by default
        });
